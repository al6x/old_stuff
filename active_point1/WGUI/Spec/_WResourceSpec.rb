...
module WGUI
	...
	describe "Web resources" do				
		it "should allow load file" do
			go 'localhost:8080/?t=Web resources'
			click 'file.txt'
			wait_for{html =~ /File for test/}
		end

		it "should display image" do
			go 'localhost:8080/?t=should display image'
		end
		...
		it "should upload file" do
			...
			go 'localhost:8080/?t=should upload file'
		...
		it "Should not raise error if invalid file path" do
			go "localhost:8080/?t=Should not raise error if invalid file path"
		...
		it "Should upload two files simultaneously" do
			...
			go 'localhost:8080/?t=Should upload two files simultaneously'
		...
		it 'file should correct works without resource' do
			go 'localhost:8080/?t=file should correct works without resource'
		end

		it "image should correct works without resource" do
			go 'localhost:8080/?t=image should correct works without resource'
		end

		it "should correct display two images one with data and another without" do
			go 'localhost:8080/?t=should correct display two images one with data and another without'
		end
		...
		it "should correct submit panel with many fields and file" do
			...
			go 'localhost:8080/?t=should correct submit panel with many fields and file'

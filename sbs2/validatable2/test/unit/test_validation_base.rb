...
Expectations do
  expect true do
    ...
    validation.send :should_validate?, Object.new
  end
  ...
  expect "some message 100" do
    validation = Validatable::ValidationBase.new stub_everything, :base, :message => lambda {|_self| "some message #{a_method}" }
    validation.send :message, stub(:a_method=>'100')
  end

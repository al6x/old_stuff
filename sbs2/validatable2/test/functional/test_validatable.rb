...
functional_tests do
  ...
  #     validates_presence_of :name, :after_validate => lambda { |_self| self.result = :is_set }
  #   end
  #
  #   instance = klass.new
  #   instance.valid?
  ...
  #     def name; child end
  #
  #     validates_true_for :name, :logic => lambda {|_self| false }, :level => 2, :message => "invalid message"
  #     include_errors_from :child
  #     define_method :child do
  ...
  #   instance = klass.new
  #   instance.valid?
  #   assert_equal ["can't be empty"], instance.errors[:name]
  # end
  ...
  #   klass = Class.new do
  #     include Validatable
  #     validates_true_for :address, :logic => lambda {|_self| false }, :level => 1, :message => "invalid message"
  #     include_errors_from :child
  #     define_method :child do
  #       @child ||= child_class.new
  #     end
  ...
  #   instance.valid?
  #   assert_equal ["can't be empty"], instance.errors[:name]
  #   assert_equal ["invalid message"], instance.errors[:address]
  # end
  ...
  #   klass = Class.new do
  #     include Validatable
  #     include_errors_from :child, :if => lambda {|_self| true }
  #     define_method :child do
  #       child_class.new
  #     end
  #   end
  ...
  #   klass = Class.new do
  #     include Validatable
  #     include_errors_from :child, :if => lambda {|_self| false }
  #     define_method :child do
  #       child_class.new
  #     end
  #   end
  ...
  #   end
  #   instance = klass.new
  #   assert_equal nil, instance.errors[:name]
  # end

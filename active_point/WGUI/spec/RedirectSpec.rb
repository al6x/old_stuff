	...
	module RedirectSpec
		...
		describe "WGUI Redirect" do
			it "should redirect during action phase" do
				go 'localhost:8080/ui?t=should_redirect_during_action_phase'
			...
			it "should redirect during state update" do
				go 'localhost:8080/ui?t=should redirect during state update&ror=a/b'
				wait_for{uri =~ /forum\/forum/}
			end

			it "should clear invalid state" do
				go 'localhost:8080/ui?t=should_clear_invalid_state&invalid_id=a/b'

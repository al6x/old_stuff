...
module WGUI
	module LinkSpec
		...
		register_wiget "link outside portlet" do
			raise "Add UIDRiver section for this test!"
...
#		start_webserver; join_webserver;
		...
		describe "Link" do
			it "link for root" do
				go 'localhost:8080/ui?t=link_for_root'
			...
			it "link for delete state" do
				go 'localhost:8080/ui?t=link for delete state&root=name1/value1/name2/value2'
				wait_for.should have_the(:link => 'link')
			...
			it "Empty link" do
				go 'localhost:8080/ui?t=Empty link&root=name1/value1/name2/value2'
			...
			it "link for inner WPortlet" do
				go 'localhost:8080/ui?t=link_for_inner_WPortlet&root=name/value'
			...
			it "Should correct displays after AJAX call (case from error)" do
				go 'localhost:8080/ui?t=Should_correct_displays_after_AJAX_call'
				click 'AJAX'
				wait_for.should have_the(:link => 'link')
			end
		end
